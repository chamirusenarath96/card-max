...
- Name: search-ux.spec.ts >> Search UX Overhaul (Feature 017) >> Scroll buttons (AC5, AC6) >> scroll buttons appear and scroll correctly (AC5, AC6)
- Location: e2e/search-ux.spec.ts:91:9
