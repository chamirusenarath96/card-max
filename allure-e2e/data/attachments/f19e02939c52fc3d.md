...
- Name: lighthouse.spec.ts >> Search dropdown timing (Feature 031) >> search dropdown hides within 500 ms after clearing input (AC3 — close)
- Location: e2e/lighthouse.spec.ts:215:7
