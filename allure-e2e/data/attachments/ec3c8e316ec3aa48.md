...
- Name: offers.spec.ts >> Offer Listing (Feature 001) >> expired offers not shown on initial load - no includeExpired param in default request
- Location: e2e/offers.spec.ts:93:7
