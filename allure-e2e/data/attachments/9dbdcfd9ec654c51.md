...
- Name: search-ux.spec.ts >> Search UX Overhaul (Feature 017) >> Scroll buttons (AC5, AC6) >> scroll-to-top button has correct aria-label (AC6)
- Location: e2e/search-ux.spec.ts:140:9
